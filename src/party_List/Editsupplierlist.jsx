...
const navigate=useNavigate()
  ...
  const res=await fetch(`http://localhost:8080/api/updatesupplierdata/${location.state}`,{
    method:'put',
    headers:{
        ...
        <div className='w-75  ' style={{ height: "40rem" }}>
            <div className='w-auto mt-3  h-16 flex flex-row justify-between '>
                ...
                <div className='sub-div  w-auto h-16 mb-4 ' style={{ borderLeft: "none", borderRight: "none", borderTop: "none" }}>
                    ...
                    <Link to='/suppliers' className='w-32  text-white ms-3 h-10 bg-purple-700 ' style={{ border: "1px solid purple", borderTop: "none", borderRight: "none", borderLeft: "none" }}>Supplier List</Link>
                    <Link to='/addnewsupplierone' className='w-36 text-white ms-3 h-14 bg-purple-700 ' style={{ border: "1px solid purple", borderTop: "none", borderRight: "none", borderLeft: "none" }}>Add New Supplier</Link>
